 ...
 return (
  ...
  >
   ...
   <div className="absolute inset-0 pointer-events-none">
    ...
    {/* Grid Pattern */}
    <div className="absolute inset-0 opacity-90 bg-[url('/Eportfolio/images/grid.svg')] bg-center [mask-image:linear-gradient(180deg,white,rgba(255,255,255,0.1))]"></div>
   ...
   <div className="grid grid-cols-1 md:grid-cols-[2fr_1fr] gap-8 items-center relative">
    ...
    <div className="relative">
     <div className="w-80 h-80 mx-auto rounded-full overflow-hidden border-4 border-green-500 relative">
      <Image
       src="/Eportfolio/images/Profile.png"
       alt="Profile"
       fill
